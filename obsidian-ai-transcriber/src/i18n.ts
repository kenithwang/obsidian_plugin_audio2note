...
const STRINGS = {
	en: {
		...
		participantsDesc: 'Optional hints for speaker naming. Gemini can identify speakers without this.',
		participantsAdd: 'Add Participant',
		participantsEmpty: 'No participants selected. Speakers will be labeled automatically.',
	...
	zh: {
		...
		participantsDesc: '可选，用于辅助命名说话人。不填写时 Gemini 会自动区分说话人。',
		participantsAdd: '新增人物',
		participantsEmpty: '未选择参会人员，将自动标记为说话人 1、2、3。',
		participantsEdit: '编辑',
